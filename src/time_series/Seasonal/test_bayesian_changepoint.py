...
data_l = data['sku_num_sum'].values
data_l = data_month['sku_num_sum'].values
data_l = data_week['sku_num_sum'].values

Q, P, Pcp = offline_changepoint_detection(data_l, partial(const_prior, l=(len(data_l) + 1)),
                                          gaussian_obs_log_likelihood, truncate=-40)
