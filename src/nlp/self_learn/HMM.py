...
epsilon = -3.14e+100
origin_path = os.path.join(uppath(1), 'Data', '264_洛炜言情小说全集83本').decode('utf-8')
corpus_path = os.path.join(uppath(1), 'Data', 'corpus')
...
def gen_corpus():
    ...
    """
    # 读取数据
    read_path = origin_path
    save_path = corpus_path
...
class HMMLgb(object):
    def __init__(self):
        ...
        self.read_path = corpus_path
        self.save_path = corpus_path
