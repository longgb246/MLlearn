        ...
        for _ in range(self.n_clf):
            ...
            for feature_i in range(n_features):
                ...
                for threshold in unique_values:
                    ...
                    # If the error is over 50% we flip the polarity so that samples that were classified as 0 are classified as 1, and vice versa
            ...
            # Calculate new weights. Missclassified samples gets larger weights and correctly classified samples smaller
