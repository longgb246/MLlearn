...
class Regression(object):
    """ Base regression model. Models the relationship between a scalar dependent variable y and the independent variables X.
...
class LassoRegression(Regression):
    ...
    def __init__(self, degree=15, reg_factor=0.05, n_iterations=3000, learning_rate=0.01):
        self.degree = degree
