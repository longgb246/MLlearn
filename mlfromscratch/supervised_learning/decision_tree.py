...
class DecisionTree(object):
    ...
    def __init__(self, min_samples_split=2, min_impurity=1e-7, max_depth=float("inf"), loss=None):
        ...
        self._impurity_calculation = None  # Function to calculate impurity (classif.=>info gain, regr=>variance reduct.)
...
class RegressionTree(DecisionTree):
    @classmethod
    def _calculate_variance_reduction(cls, y, y1, y2):
