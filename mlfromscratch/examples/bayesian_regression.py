...
def main():
    ...
    # data = pd.read_csv('/Users/longguangbin/Work/Codes/MLlearn/mlfromscratch/data/TempLinkoping2016.txt', sep="\t")
    ...
    # - The variance of the weights are assumed distributed according to a scaled inverse chi-squared distribution.
