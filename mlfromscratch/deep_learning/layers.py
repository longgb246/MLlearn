...
class Conv2D(Layer):
    ...
    def forward_pass(self, X, training=True):
        # X = np.array([[2, 3, 4, 2, 3, 2, 4, 5, 1, 2, 3, 1, 5, 3, 2, 1, 5, 1, 2, 3, 1, 5, 3, 2, 1],
        #               [3, 4, 2, 3, 2, 4, 5, 1, 2, 3, 1, 5, 3, 2, 1, 2, 5, 5, 1, 2, 3, 1, 5, 3, 2]]).reshape(-1, 1, 5, 5)
...
def image_to_column(images, filter_shape, stride, output_shape='same'):
    # X, self.filter_shape (3, 3), stride=self.stride 1, output_shape=self.padding 'same'
    # images = X
    filter_height, filter_width = filter_shape
