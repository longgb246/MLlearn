...
class ModelFactory(object):
    ...
    def train(self, model, toy, join_generator, val_generator):
        ...
        print('Toy:{toy}, epochs:{epochs}, steps per epoch: {steps_per_epoch}, validation steps:{validation_steps}')
        print('Batch_size:{batch_size}, validation batch size:{validation_batch_size}')
